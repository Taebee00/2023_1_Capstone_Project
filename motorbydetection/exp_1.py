...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            pwm.set_pwm_freq(60)
            if (int((3*y+30) * 2.8) < 170) :
                pwm.set_pwm(8, 0, 150 + int((3*y+30) * 2.8))
            if (int((3*x+30) * 2.8) < 170) :
                pwm.set_pwm(12, 0, 150 + int((3*x+30) * 2.8))
        ...
        # cv2.putText(image, (20,450), cv2.FONT_HERSHEY_SIMPLEX, 1.5, (0,255,0), 2)
