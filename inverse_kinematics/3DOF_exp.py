...
def threeTotwo(x, y, z, theta_alpha) :
    ...
    z_p = z + l_3 * math.sin(theta_alpha) if theta_alpha >= 0 else z - l_3 * math.sin(theta_alpha)
    
    print(x_p, y_p, z_p)
    
    return theta_0, x_p, y_p, z_p
...
def CalculateTheta(x,y,z,theta_alpha):
    ...
    theta_3 = (theta_2 - theta_1) + (math.pi/2) - theta_alpha  
